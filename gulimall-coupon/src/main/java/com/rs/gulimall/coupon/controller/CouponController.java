package com.rs.gulimall.coupon.controller;
...
import com.rs.gulimall.coupon.service.CouponService;
...
public class CouponController {
    ...
    @RequestMapping("/test")
    public R test(){
        return R.ok().put("name", userName).put("age", age).put("gulimall-user", userName2);
    }
